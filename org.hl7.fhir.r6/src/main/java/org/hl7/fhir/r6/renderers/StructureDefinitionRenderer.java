...
import org.hl7.fhir.r6.comparison.VersionComparisonAnnotation;
import org.hl7.fhir.r6.conformance.profile.BindingResolution;
import org.hl7.fhir.r6.conformance.profile.ProfileUtilities;
import org.hl7.fhir.r6.conformance.profile.ProfileUtilities.ElementChoiceGroup;
import org.hl7.fhir.r6.conformance.profile.ProfileUtilities.ExtensionContext;
import org.hl7.fhir.r6.conformance.profile.SnapshotGenerationPreProcessor;
import org.hl7.fhir.r6.context.ExpansionOptions;
import org.hl7.fhir.r6.context.IWorkerContext;
import org.hl7.fhir.r6.extensions.ExtensionDefinitions;
import org.hl7.fhir.r6.extensions.ExtensionUtilities;
import org.hl7.fhir.r6.formats.IParser;
import org.hl7.fhir.r6.formats.IParser.OutputStyle;
import org.hl7.fhir.r6.formats.JsonParser;
import org.hl7.fhir.r6.formats.XmlParser;
import org.hl7.fhir.r6.model.ActorDefinition;
import org.hl7.fhir.r6.model.Base;
import org.hl7.fhir.r6.model.BooleanType;
import org.hl7.fhir.r6.model.CanonicalResource;
import org.hl7.fhir.r6.model.CanonicalType;
import org.hl7.fhir.r6.model.CodeSystem;
import org.hl7.fhir.r6.model.CodeType;
import org.hl7.fhir.r6.model.CodeableConcept;
...
import org.hl7.fhir.r6.model.DataType;
import org.hl7.fhir.r6.model.DecimalType;
import org.hl7.fhir.r6.model.Element;
import org.hl7.fhir.r6.model.ElementDefinition;
import org.hl7.fhir.r6.model.ElementDefinition.AdditionalBindingPurposeVS;
import org.hl7.fhir.r6.model.ElementDefinition.AggregationMode;
import org.hl7.fhir.r6.model.ElementDefinition.DiscriminatorType;
import org.hl7.fhir.r6.model.ElementDefinition.ElementDefinitionBindingAdditionalComponent;
import org.hl7.fhir.r6.model.ElementDefinition.ElementDefinitionBindingComponent;
import org.hl7.fhir.r6.model.ElementDefinition.ElementDefinitionConstraintComponent;
import org.hl7.fhir.r6.model.ElementDefinition.ElementDefinitionExampleComponent;
import org.hl7.fhir.r6.model.ElementDefinition.ElementDefinitionMappingComponent;
import org.hl7.fhir.r6.model.ElementDefinition.ElementDefinitionSlicingComponent;
import org.hl7.fhir.r6.model.ElementDefinition.ElementDefinitionSlicingDiscriminatorComponent;
import org.hl7.fhir.r6.model.ElementDefinition.PropertyRepresentation;
import org.hl7.fhir.r6.model.ElementDefinition.SlicingRules;
import org.hl7.fhir.r6.model.ElementDefinition.TypeRefComponent;
import org.hl7.fhir.r6.model.Enumeration;
import org.hl7.fhir.r6.model.Extension;
import org.hl7.fhir.r6.model.IdType;
import org.hl7.fhir.r6.model.IntegerType;
import org.hl7.fhir.r6.model.MarkdownType;
import org.hl7.fhir.r6.model.PrimitiveType;
import org.hl7.fhir.r6.model.Quantity;
import org.hl7.fhir.r6.model.Resource;
import org.hl7.fhir.r6.model.StringType;
import org.hl7.fhir.r6.model.StructureDefinition;
import org.hl7.fhir.r6.model.StructureDefinition.StructureDefinitionKind;
import org.hl7.fhir.r6.model.StructureDefinition.StructureDefinitionMappingComponent;
import org.hl7.fhir.r6.model.StructureDefinition.TypeDerivationRule;
import org.hl7.fhir.r6.model.UriType;
import org.hl7.fhir.r6.model.ValueSet;
import org.hl7.fhir.r6.model.ValueSet.ValueSetExpansionContainsComponent;
import org.hl7.fhir.r6.renderers.mappings.ConceptMapMappingProvider;
import org.hl7.fhir.r6.renderers.mappings.ModelMappingProvider;
import org.hl7.fhir.r6.renderers.mappings.StructureDefinitionMappingProvider;
import org.hl7.fhir.r6.renderers.utils.ElementTable;
import org.hl7.fhir.r6.renderers.utils.ElementTable.ElementTableGrouping;
import org.hl7.fhir.r6.renderers.utils.ElementTable.ElementTableGroupingEngine;
import org.hl7.fhir.r6.renderers.utils.ElementTable.ElementTableGroupingState;
import org.hl7.fhir.r6.renderers.utils.ElementTable.HintDrivenGroupingEngine;
import org.hl7.fhir.r6.renderers.utils.ElementTable.JsonDrivenGroupingEngine;
import org.hl7.fhir.r6.renderers.utils.ElementTable.TableElement;
import org.hl7.fhir.r6.renderers.utils.ElementTable.TableElementConstraint;
import org.hl7.fhir.r6.renderers.utils.ElementTable.TableElementConstraintType;
import org.hl7.fhir.r6.renderers.utils.ElementTable.TableElementDefinition;
import org.hl7.fhir.r6.renderers.utils.ElementTable.TableElementDefinitionType;
import org.hl7.fhir.r6.renderers.utils.ElementTable.TableGroup;
import org.hl7.fhir.r6.renderers.utils.RenderingContext;
import org.hl7.fhir.r6.renderers.utils.RenderingContext.FixedValueFormat;
import org.hl7.fhir.r6.renderers.utils.RenderingContext.GenerationRules;
import org.hl7.fhir.r6.renderers.utils.RenderingContext.KnownLinkType;
import org.hl7.fhir.r6.renderers.utils.RenderingContext.StructureDefinitionRendererMode;
import org.hl7.fhir.r6.renderers.utils.ResourceWrapper;
import org.hl7.fhir.r6.terminologies.expansion.ValueSetExpansionOutcome;
import org.hl7.fhir.r6.terminologies.utilities.ValidationResult;
import org.hl7.fhir.r6.utils.EOperationOutcome;
import org.hl7.fhir.r6.utils.PublicationHacker;

import org.hl7.fhir.r6.utils.UserDataNames;
...
//          log("This shouldn't happen?");
  ...
  private ElementInStructure getElementByName(List<ElementDefinition> elements, String contentReference, StructureDefinition source) { 
    if (contentReference.contains("#")) { 
      ...
      if (!url.equals(source.getUrl())) { 
        source = context.getProfileUtilities().findProfileStr(url, source);
        if (source == null) { 
  ...
  private List<ModelMappingProvider> scanForMappings(StructureDefinition profile, List<ElementDefinition> list, List<Column> columns) {
    ...
    for (StructureDefinitionMappingComponent map : profile.getMapping()) {
      if (map.hasUri()) {
        StructureDefinition sd = context.getProfileUtilities().findProfile(map.getUriElement(), profile);
    ...
    for (ConceptMap cm : context.getContext().fetchResourcesByType(ConceptMap.class)) {
      for (ConceptMapGroupComponent grp : cm.getGroup()) {
        if (grp.hasSource() && grp.getSource().equals(profile.getUrl())) {
          ...
          if (url != null) {
            StructureDefinition sd = context.getProfileUtilities().findProfile(grp.getTargetElement(), profile);
    ...
    for (ConceptMap cm : context.getContext().fetchResourcesByType(ConceptMap.class)) {
      for (ConceptMapGroupComponent grp : cm.getGroup()) {
        if (grp.hasTarget() && grp.getTarget().equals(profile.getUrl())) {
          ...
          if (url != null) {
            StructureDefinition sd = context.getProfileUtilities().findProfile(grp.getSourceElement(), profile);
            if (includeSDForMap(sd, false) && !items.contains(sd)) {
              matched = true;
              items.add(sd);
  ...
  private boolean scanObligations(List<Column> columns, List<ElementDefinition> list) { 
    ...
    for (String col : cols) { 
      if (!"$all".equals(col)) { 
        ActorDefinition actor = context.getWorker().fetchResource(ActorDefinition.class, col, IWorkerContext.VersionResolutionRules.defaultRule());
        if (actor == null) { 
  ...
  public Cell generateDescription(RenderingStatus status, HierarchicalTableGenerator gen, Row row, ElementDefinition definition, ElementDefinition fallback, String baseURL, String url, StructureDefinition profile, String corePath, String imagePath, boolean root, boolean logicalModel, boolean allInvariants, ElementDefinition valueDefn, boolean snapshot, boolean mustSupportOnly, boolean allowSubRows, RenderingContext rc, List<ElementDefinition> inScopeElements, ResourceWrapper res) throws IOException, FHIRException {
    ...
    if (definition.getPath().endsWith("url") && definition.hasFixed()) {
      ...
      if (url != null) {
        ...
        StructureDefinition ed = context.getProfileUtilities().findProfileStr(url, profile);
        String ref = null;
        String ref2 = null;
        ...
        if (ed != null) {
          ...
          if (fixedUrl != null) {// if its null, we guess that it's not a profiled extension?
            if (fixedUrl.equals(url))
              ...
              StructureDefinition ed2 = context.getProfileUtilities().findProfileStr(fixedUrl, profile);
              if (ed2 != null) {
      ...
      if (root) {
        ...
        if (profile.hasExtension(ExtensionDefinitions.EXT_RESOURCE_IMPLEMENTS)) {
          ...
          for (Extension fi : profile.getExtensionsByUrl(ExtensionDefinitions.EXT_RESOURCE_IMPLEMENTS)) {
            ...
            StructureDefinition sdt = context.getWorker().fetchResource(StructureDefinition.class, fi.getValue().primitiveValue(), ExtensionUtilities.getVersionResolutionRules(fi.getValue()));
            if (sdt != null) {
...
//            if (!inv.hasSource() || profile == null || inv.getSource().equals(profile.getUrl()) || allInvariants) { 
  ...
  private boolean isAbstractBaseProfile(String source, StructureDefinition resource) {
    StructureDefinition sd = context.getProfileUtilities().findProfileStr(source, resource);
  ...
  private void getAncestorElements(List<String> inscope, StructureDefinition profile, List<SourcedElementDefinition> ancestors) { 
    StructureDefinition base = context.getProfileUtilities().findProfile(profile.getBaseDefinitionElement(), profile);
    if (base != null) { 
  ...
  private void addCanonicalList(HierarchicalTableGenerator gen, Cell c, List<CanonicalType> list, String start, boolean bold, StructureDefinition source) throws IOException {
    if (!list.isEmpty()) { 
      ...
      for (int i = 0; i < list.size(); i++) { 
        ...
        StructureDefinition sd = context.getProfileUtilities().findProfile(ct, source);
        if (sd == null) {
  ...
  private Cell genTypes(HierarchicalTableGenerator gen, Row r, ElementDefinition e, String profileBaseFileName, StructureDefinition profile, String corePath, String imagePath, boolean root, boolean mustSupportMode, boolean diff) {
    ...
    if (!e.hasType()) { 
      if (root) { // we'll use base instead of types then 
        StructureDefinition bsd = profile == null ? null : context.getProfileUtilities().findProfile(profile.getBaseDefinitionElement(), profile);
        if (bsd != null) { 
          String v = ""; 
      ...
      if (!mustSupportMode || allTypesMustSupport(e) || isMustSupport(t)) { 
        ...
        if (t.hasTarget()) { 
          if (t.hasProfile()) { 
            ...
            StructureDefinition tsd = context.getProfileUtilities().findProfile(t.getProfile().get(0), profile);
            if (tsd != null) { 
  ...
  private ExtensionContext locateExtension(Class<StructureDefinition> class1, String value, StructureDefinition sd)  {
    if (value.contains("#")) { 
      StructureDefinition ext = context.getProfileUtilities().findProfileStr(value.substring(0, value.indexOf("#")), sd);
      if (ext == null) 
        return null; 
      ...
      StructureDefinition ext = context.getProfileUtilities().findProfileStr(value, sd);
      if (ext == null) 
        return null; 
      else  
  ...
  private void genFixedValue(HierarchicalTableGenerator gen, Row erow, DataType value, boolean snapshot, boolean pattern, String corePath, boolean skipnoValue, String path, String id, List<ElementDefinition> inScopeElements) { 
    ...
    for (org.hl7.fhir.r6.model.Property t : value.children()) { 
    ...
    for (TypeRefComponent tr : element.getType()) { 
      if (!mustSupportMode || allTypesMustSupport(element) || isMustSupport(tr)) { 
        ...
        if (Utilities.isAbsoluteUrl(ts)) {
          StructureDefinition sd = context.getProfileUtilities().findProfileStr(ts, src);
          if (sd != null) {
            ts = sd.getType();
          }
        }
          ...
          if (tr.hasProfile() && used) { 
            ...
            for (CanonicalType pt : tr.getProfile()) { 
              if (!mustSupportMode || allProfilesMustSupport(tr.getProfile()) || isMustSupport(pt)) { 
                ...
                StructureDefinition psd = context.getProfileUtilities().findProfile(pt, src);
                if (psd == null) 
  ...
  private SpanEntry buildSpanEntryFromProfile(String name, String cardinality, StructureDefinition profile) throws IOException { 
    ...
    StructureDefinition base = context.getProfileUtilities().findProfileStr(res.getResType(), profile);
    if (base != null) 
        ...
        if (!"0".equals(ed.getMax()) && ed.getType().size() > 0) { 
          ...
          if (!card.endsWith(".0")) { 
            ...
            if (refProfiles.size() > 0) { 
              ...
              if (uri != null) { 
                StructureDefinition sd = context.getProfileUtilities().findProfileStr(uri, profile);
    ...
    for (ElementDefinition ec : elements) { 
      if ((incProfiledOut || !"0".equals(ec.getMax())) && !excluded.contains(ec)) { 
        ...
        if (isProfiledExtension(ec)) { 
          StructureDefinition extDefn = context.getProfileUtilities().findProfile(ec.getType().get(0).getProfile().get(0), sd);
          if (extDefn == null) { 
            ...
            try { 
              StructureDefinition compareExtDefn = context.getProfileUtilities().findProfile(compareElement.getType().get(0).getProfile().get(0), sd);
  ...
  public ElementDefinition getElementById(String url, String id, StructureDefinition srcSd) {
    ...
    if (sdCache == null) { 
      StructureDefinition sd = (StructureDefinition) context.getProfileUtilities().findProfileStr(url, srcSd);
      if (sd == null) { 
        if (url.equals("http://hl7.org/fhir/StructureDefinition/Base")) { 
          sd = (StructureDefinition) context.getProfileUtilities().findProfileStr("http://hl7.org/fhir/StructureDefinition/Element", null);
        } 
        if (sd == null) { 
...
//    int slicedExtensionMode = (mode == GEN_MODE_KEY) && slicedExtension ? GEN_MODE_SNAP : mode; // see ProfileUtilities.checkExtensionDoco / Task 3970 
    ...
    if (d.hasExtension(ExtensionDefinitions.EXT_STANDARDS_STATUS)) { 
      ...
      StructureDefinition sdb = context.getProfileUtilities().findProfile(sd.getBaseDefinitionElement(), sd);
      if (sdb != null) { 
    ...
    if (obr.hasObligations() || (root && (sdx.hasExtension(ExtensionDefinitions.EXT_OBLIGATION_PROFILE_FLAG_NEW, ExtensionDefinitions.EXT_OBLIGATION_PROFILE_FLAG_OLD) || sdx.hasExtension(ExtensionDefinitions.EXT_OBLIGATION_INHERITS_NEW, ExtensionDefinitions.EXT_OBLIGATION_INHERITS_OLD)))) {
      ...
      if (root) { 
        ...
        for (Extension ext : sdx.getExtensionsByUrl(ExtensionDefinitions.EXT_OBLIGATION_INHERITS_NEW, ExtensionDefinitions.EXT_OBLIGATION_INHERITS_OLD)) {
          ...
          StructureDefinition sd = context.getProfileUtilities().findProfile(ext.getValueUriType(), sdx);
          if (sd == null) {  
            bb.code().tx(iu);                      
  ...
  private XhtmlNode describeAllowedUnits(ElementDefinition d) { 
    ...
    if (au instanceof CanonicalType) { 
      ...
      ValueSet vs = context.getContext().findTxResource(ValueSet.class, url, ExtensionUtilities.getVersionResolutionRules(au));
  ...
  private XhtmlNode renderCanonicalList(String text, List<CanonicalType> list) { 
    ...
    for (CanonicalType ct : list) { 
      CanonicalResource cr = (CanonicalResource) context.getContext().fetchResource(Resource.class,  ct.getValue(), ExtensionUtilities.getVersionResolutionRules(ct));
  ...
  private StandardsStatus determineStandardsStatus(StructureDefinition sd, ElementDefinition ed) { 
    ...
    while (sd != null) { 
      ...
      sd = context.getProfileUtilities().findProfile(sd.getBaseDefinitionElement(), sd);
    } 
    return null; 
  } 
  ...
  private ResolvedCanonical fetchProfile(CanonicalType pt, boolean mustSupportOnly, StructureDefinition sd) {
    ...
    if (!mustSupportOnly || isMustSupport(pt)) { 
      StructureDefinition p = context.getProfileUtilities().findProfile(pt, sd);
...
//  } 
  ...
  public void checkValueDomainConstraints(ElementDefinition defn, ElementDefinition diffDefn, String path, TableElement e, boolean cardinality, StructureDefinition sd) {
    ...
    if (defn.hasFixed()) {
      e.getConstraints().add(TableElementConstraint.makeValueVS(TableElementConstraintType.FIXED, path, defn.getFixed(), defn.getBinding().getStrength(), defn.getBinding().getValueSet(), defn.getBinding().getValueSetElement(), sd));
    }
    if (defn.hasPattern()) {
      e.getConstraints().add(TableElementConstraint.makeValueVS(TableElementConstraintType.PATTERN, path, defn.getPattern(), defn.getBinding().getStrength(), defn.getBinding().getValueSet(), defn.getBinding().getValueSetElement(), sd));
    }
    ...
    if (defn.hasBinding() && defn.getBinding().hasValueSet() && (!cardinality || (diffDefn != null && diffDefn.hasBinding())) && !defn.hasFixedOrPattern()) {
      e.getConstraints().add(TableElementConstraint.makeBinding(TableElementConstraintType.BINDING, path, defn.getBinding().getStrength(), defn.getBinding().getValueSet(), defn.getBinding().getValueSetElement(), sd));
    }
  }
