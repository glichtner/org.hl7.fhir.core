...
import org.hl7.fhir.r6.fhirpath.FHIRPathFunctionDefinition;
...
import org.hl7.fhir.r6.testfactory.dataprovider.ValueSetDataProvider;
  ...
  public TableDataProvider loadTableProvider(String path, Locale locale) {
    ...
    if (Utilities.isAbsoluteUrl(path)) {
      ...
      if (vs == null) {
        ...
        org.hl7.fhir.r6.terminologies.expansion.ValueSetExpansionOutcome exp = context.expandVS(vs, true, false);
        if (exp.isOk()) {
