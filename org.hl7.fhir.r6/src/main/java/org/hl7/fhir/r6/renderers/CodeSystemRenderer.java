...
import org.hl7.fhir.r6.model.CodeSystem.CodeSystemHierarchyMeaning;
...
import org.hl7.fhir.r6.renderers.utils.RenderingContext.MultiLanguagePolicy;
import org.hl7.fhir.r6.renderers.utils.ResourceWrapper;
import org.hl7.fhir.r6.terminologies.CodeSystemUtilities;
import org.hl7.fhir.r6.terminologies.CodeSystemUtilities.CodeSystemNavigator;
  ...
  private void generateFilters(XhtmlNode x, CodeSystem cs) {
    if (cs.hasFilter()) {
      ...
      for (CodeSystemFilterComponent f : cs.getFilter()) {
        ...
        XhtmlNode td = tr.td();
        for (Enumeration<org.hl7.fhir.r6.model.Enumerations.FilterOperator> t : f.getOperator())
