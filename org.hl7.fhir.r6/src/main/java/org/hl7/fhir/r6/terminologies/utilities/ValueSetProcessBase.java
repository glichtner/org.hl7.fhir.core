package org.hl7.fhir.r6.terminologies.utilities;
...
import org.hl7.fhir.r6.model.UrlType;
import org.hl7.fhir.r6.model.ValueSet;
import org.hl7.fhir.r6.model.ValueSet.ValueSetExpansionComponent;

import org.hl7.fhir.r6.terminologies.expansion.OperationIsTooCostly;
...
public class ValueSetProcessBase {
  ...
  protected List<OperationOutcomeIssueComponent> makeIssue(IssueSeverity level, IssueType type, String location, String message, OpIssueCode code, String server, String msgId) {
    ...
    switch (level) {
    case ERROR:
      result.setSeverity(org.hl7.fhir.r6.model.OperationOutcome.IssueSeverity.ERROR);
      break;
    case FATAL:
      result.setSeverity(org.hl7.fhir.r6.model.OperationOutcome.IssueSeverity.FATAL);
      break;
    case INFORMATION:
      result.setSeverity(org.hl7.fhir.r6.model.OperationOutcome.IssueSeverity.INFORMATION);
      break;
    case WARNING:
      result.setSeverity(org.hl7.fhir.r6.model.OperationOutcome.IssueSeverity.WARNING);
      break;
    }
    result.setCode(type);
    if (location != null) {
