package org.hl7.fhir.r6.comparison;
...
import org.hl7.fhir.r6.comparison.CapabilityStatementComparer.CapabilityStatementComparison;
import org.hl7.fhir.r6.comparison.CodeSystemComparer.CodeSystemComparison;
import org.hl7.fhir.r6.comparison.ResourceComparer.PlaceHolderComparison;
import org.hl7.fhir.r6.comparison.ResourceComparer.ResourceComparison;
import org.hl7.fhir.r6.comparison.StructureDefinitionComparer.ProfileComparison;
import org.hl7.fhir.r6.comparison.ValueSetComparer.ValueSetComparison;
...
import org.hl7.fhir.r6.liquid.LiquidEngine;
import org.hl7.fhir.r6.liquid.LiquidEngine.LiquidDocument;
...
public class ComparisonRenderer implements IHostApplicationServices {
  ...
  private void renderCodeSystem(String id, CodeSystemComparison comp) throws IOException, FHIRFormatError, DefinitionException, FHIRException, EOperationOutcome {  
    ...
    String cnt = processTemplate(template, "CodeSystem", vars);
    FileUtilities.stringToFile(cnt, file(comp.getId()+".html"));
    new org.hl7.fhir.r6.formats.JsonParser().setOutputStyle(OutputStyle.PRETTY).compose(ManagedFileAccess.outStream(Utilities.path(folder, comp.getId() + "-union.json")), comp.getUnion());
    new org.hl7.fhir.r6.formats.JsonParser().setOutputStyle(OutputStyle.PRETTY).compose(ManagedFileAccess.outStream(Utilities.path(folder, comp.getId() + "-intersection.json")), comp.getIntersection());
