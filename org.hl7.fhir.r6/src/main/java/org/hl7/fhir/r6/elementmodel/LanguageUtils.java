...
import org.hl7.fhir.r6.elementmodel.Element.SpecialElement;
...
public class LanguageUtils {
  ...
  private int importResourceFromTranslations(Base parent, Base element, List<TranslationUnit> translations, Set<TranslationUnit> usedUnits, String path) {
    int t = 0;
    if (element.isPrimitive() && isTranslatable(element, path) && element instanceof org.hl7.fhir.r6.model.Element) {
      org.hl7.fhir.r6.model.Element e = (org.hl7.fhir.r6.model.Element) element;
      String base = element.primitiveValue();
      if (base != null) {
  ...
  public boolean hasTranslation(org.hl7.fhir.r6.model.Element e, String lang) {
    return getTranslation(e, lang) != null;
  }

  public String getTranslation(org.hl7.fhir.r6.model.Element e, String lang) {
