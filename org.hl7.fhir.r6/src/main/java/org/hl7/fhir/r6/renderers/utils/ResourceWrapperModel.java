...
public class ResourceWrapperModel extends ResourceWrapper {
  ...
  public void setNarrative(XhtmlNode x, String status, boolean multiLangMode, Locale locale, boolean isPretty) throws IOException {
    org.hl7.fhir.r6.elementmodel.Element txt = model.getNamedChild("text");
    if (txt == null) {
      txt = new org.hl7.fhir.r6.elementmodel.Element("text", model.getProperty().getChild(null, "text"));
      int i = 0;
    ...
    org.hl7.fhir.r6.elementmodel.Element st = txt.getNamedChild("status");
    if (st == null) {
      st = new org.hl7.fhir.r6.elementmodel.Element("status", txt.getProperty().getChild(null, "status"));
      txt.getChildren().add(0, st);
    }
    st.setValue(status);
    org.hl7.fhir.r6.elementmodel.Element div = txt.getNamedChild("div");
    if (div == null) {
      div = new org.hl7.fhir.r6.elementmodel.Element("div", txt.getProperty().getChild(null, "div"));
