...
public class TypeConvertor {
  ...
  public static DataType castToType(Base b) throws FHIRException {
    ...
    if (b instanceof DataType)
      ...
      return ((org.hl7.fhir.r6.elementmodel.Element) b).asType();
    else
  ...
  public static DosageCondition castToDosageCondition(Base b) throws FHIRException {
    if (b == null) {
      return null;
    }
  ...
  public static DosageDetails castToDosageDetails(Base b) throws FHIRException {
    if (b == null) {
      return null;
    }
  ...
  public static DosageSafety castToDosageSafety(Base b) throws FHIRException {
    if (b == null) {
      return null;
    }
  ...
  public static RelativeTime castToRelativeTime(Base b) throws FHIRException {
    if (b == null) {
      return null;
    }
  ...
  public static Money castToMoney(Base b) throws FHIRException {
    ...
    if (b instanceof Money)
      return (Money) b;
    else if (b instanceof org.hl7.fhir.r6.elementmodel.Element && Utilities.tail(b.fhirType()).equals("Money")) {
      org.hl7.fhir.r6.elementmodel.Element e = (org.hl7.fhir.r6.elementmodel.Element) b;
  ...
  public static Reference castToReference(Base b) throws FHIRException {
    ...
    else if (b instanceof org.hl7.fhir.r6.elementmodel.Element && Utilities.tail(b.fhirType()).equals("Reference")) {
      org.hl7.fhir.r6.elementmodel.Element e = (org.hl7.fhir.r6.elementmodel.Element) b;
