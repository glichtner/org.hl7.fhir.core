package org.hl7.fhir.r6.extensions;
...
public class ExtensionUtilities {
  ...
  public static void addFlyOver(Questionnaire.QuestionnaireItemComponent item, String text, String linkId){
    if (!StringUtils.isBlank(text)) {
      ...
      display.setType(Questionnaire.QuestionnaireItemTypeUsable.DISPLAY);
  ...
  private static ValidationMessage.IssueType mapType(org.hl7.fhir.r6.model.OperationOutcome.IssueType code) {
    if (code == null) {
      return null;
    }
    switch (code) {
  ...
  private static ValidationMessage.IssueSeverity mapSeverity(org.hl7.fhir.r6.model.OperationOutcome.IssueSeverity severity) {
    if (severity == null) {
      return null;
    }
    switch (severity) {
  ...
  public static IWorkerContext.VersionResolutionRules getVersionResolutionRules(org.hl7.fhir.r6.elementmodel.Element element) {
    if (element == null) {
      return IWorkerContext.VersionResolutionRules.defaultRule();
    }
    String rule = element.getExtensionString(ExtensionDefinitions.CANONICAL_RESOLUTION_METHOD);
  ...
  public static IWorkerContext.VersionResolutionRules getVersionResolutionRulesBase(Base base) {
    ...
    if (base instanceof org.hl7.fhir.r6.elementmodel.Element) {
      return getVersionResolutionRules((org.hl7.fhir.r6.elementmodel.Element) base);
