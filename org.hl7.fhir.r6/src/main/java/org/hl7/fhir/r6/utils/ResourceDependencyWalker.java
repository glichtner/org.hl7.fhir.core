...
import org.hl7.fhir.r6.model.CapabilityStatement.CapabilityStatementRestComponent;
import org.hl7.fhir.r6.model.CapabilityStatement.CapabilityStatementRestResourceComponent;
import org.hl7.fhir.r6.model.CapabilityStatement.CapabilityStatementRestResourceOperationComponent;
import org.hl7.fhir.r6.model.CapabilityStatement.CapabilityStatementRestResourceSearchParamComponent;
...
import org.hl7.fhir.r6.model.ConceptMap.AdditionalAttributeComponent;
...
import org.hl7.fhir.r6.model.DomainResource;
...
import org.hl7.fhir.r6.model.OperationDefinition.OperationDefinitionParameterComponent;
import org.hl7.fhir.r6.model.Questionnaire;
import org.hl7.fhir.r6.model.Questionnaire.QuestionnaireItemAnswerOptionComponent;
import org.hl7.fhir.r6.model.Questionnaire.QuestionnaireItemComponent;
import org.hl7.fhir.r6.model.Questionnaire.QuestionnaireItemEnableWhenComponent;
import org.hl7.fhir.r6.model.Questionnaire.QuestionnaireItemInitialComponent;
import org.hl7.fhir.r6.model.Reference;
import org.hl7.fhir.r6.model.RelatedArtifact;
import org.hl7.fhir.r6.model.Resource;
import org.hl7.fhir.r6.model.SearchParameter;
import org.hl7.fhir.r6.model.SearchParameter.SearchParameterComponentComponent;
...
public class ResourceDependencyWalker {
  ...
  private void walkIntoLink(String value, CanonicalResource source) {
    if (value != null ) {
      ...
      if (!processedLinks.contains(key)) {
        ...
        Resource tgt = context.fetchResource(Resource.class, value, IWorkerContext.VersionResolutionRules.defaultRule(), null, source);
  ...
  private boolean isCore(Resource tgt) {
    return tgt.hasSourcePackage() && "hl7.fhir.r6.core".equals(tgt.getSourcePackage().getId());
  }
  ...
  private void walkQItem(QuestionnaireItemComponent item, Questionnaire q) {
    for (org.hl7.fhir.r6.model.UriType d : item.getDefinition()) walkIntoLink(d.getValue(), q);
  ...
  private void walkCM(ConceptMap cm) {
    ...
    for (org.hl7.fhir.r6.model.ConceptMap.PropertyComponent prop : cm.getProperty()) {
