...
import org.hl7.fhir.r6.renderers.utils.Resolver.IReferenceResolver;
...
//    private Map<String, StringPair> namedLinks = new HashMap<>();
  ...
  public String getTranslatedCode(Base b, String codeSystem) {
    if (b instanceof org.hl7.fhir.r6.model.Element) {
      org.hl7.fhir.r6.model.Element e = (org.hl7.fhir.r6.model.Element) b;
