  ...
  private class PEGenClass {
    ...
    private String generateEnum(PEDefinition source, PEDefinition field) {
      if (field.definition().hasBinding() && !field.hasFixedValue()) {
        ...
        if (binding.getStrength() == org.hl7.fhir.r6.model.Enumerations.BindingStrength.REQUIRED && binding.hasValueSet()) {
          org.hl7.fhir.r6.model.ValueSet vs = workerContext.fetchResource(org.hl7.fhir.r6.model.ValueSet.class, binding.getValueSet(),
