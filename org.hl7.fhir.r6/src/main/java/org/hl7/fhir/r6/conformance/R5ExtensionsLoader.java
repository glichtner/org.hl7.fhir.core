...
import org.hl7.fhir.r6.conformance.R5ExtensionsLoader.Loadable;
...
import org.hl7.fhir.r6.utils.ResourceSorters;
...
public class R5ExtensionsLoader {
  ...
  public void load() throws FHIRException, IOException {
    pckCore = pcm.loadPackage("hl7.fhir.r6.core", "5.0.0");
    loadDetails(pckCore); 
  }
