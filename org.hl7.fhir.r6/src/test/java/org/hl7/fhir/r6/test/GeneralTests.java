...
import org.hl7.fhir.r6.elementmodel.ParserBase.ValidationPolicy;
  ...
  void testXMLParse() {
    assertDoesNotThrow(() -> {
      ...
      InputStream stream = TestingUtilities.loadTestResourceStream("validator",
        "xml_v10.xml");
      org.hl7.fhir.r6.elementmodel.XmlParser xp = new org.hl7.fhir.r6.elementmodel.XmlParser(TestingUtilities.getSharedWorkerContext());
