...
import org.hl7.fhir.r6.utils.sql.Provider;
import org.hl7.fhir.r6.utils.sql.Runner;
import org.hl7.fhir.r6.utils.sql.StorageJson;
    ...
    public List<Base> fetch(String resourceType) {
      ...
      for (JsonObject res : details.resources) {
        try {
          ...
          Resource resource = new org.hl7.fhir.r6.formats.JsonParser().parse(src);
