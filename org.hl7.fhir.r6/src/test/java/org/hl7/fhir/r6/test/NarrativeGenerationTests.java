...
import org.hl7.fhir.r6.renderers.utils.RenderingContext.ITypeParser;
...
import org.hl7.fhir.r6.test.utils.CompareUtilities;
...
public class NarrativeGenerationTests {
  ...
  public static class TestTypeParser implements ITypeParser {
    ...
    public Base parseType(String xml, String type) throws FHIRFormatError, IOException, FHIRException {
      return new org.hl7.fhir.r6.formats.XmlParser().parseType(xml, type); 
    }
    @Override
    public Base parseType(org.hl7.fhir.r6.elementmodel.Element e) throws FHIRFormatError, IOException, FHIRException {
      throw new NotImplementedException(); 
    }
  }
  ...
  public void test(String id, TestDetails test) throws Exception {
    ...
    //    
//    if (test.isMeta()) {
//      org.hl7.fhir.r6.elementmodel.Element e = Manager.parseSingle(context, TestingUtilities.loadTestResourceStream("r5", "narrative", test.getId() + ".xml"), FhirFormat.XML); 
