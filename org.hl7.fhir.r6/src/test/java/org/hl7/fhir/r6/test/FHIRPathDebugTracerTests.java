...
import org.hl7.fhir.r6.fhirpath.FHIRPathEngine.ExecutionContext;
...
public class FHIRPathDebugTracerTests {
  ...
  private org.hl7.fhir.r6.elementmodel.Element loadTestResource(String filename)
    ...
    org.hl7.fhir.r6.elementmodel.Element e = p.parse(res);
    return e;
  }
